...
:: Android packaging
set AND_CERT_NAME="Cutie Crawler"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CutieCrawler.p12
...
set IOS_PROVISION=cert\CutieCrawler.mobileprovision
...
set APP_ID=air.com.stichoza.cutiecrawler.CutieCrawler

:: Output packages
set DIST_PATH=dist
set DIST_NAME=CutieCrawler
